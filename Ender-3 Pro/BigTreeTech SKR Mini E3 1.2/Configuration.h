...
#define STRING_CONFIG_H_AUTHOR "(tooms73, Ender-3 Pro)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100.22 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -9.5, -3 }
